...
namespace GameUtil.Algorithm.Maze 
{
    ...
    public abstract class MazeAlgorithm
    {
        ...
        {
            MazePostProcesser mpp = (MazePostProcesser)System.Activator.CreateInstance(System.Type.GetType("GameUtil.Algorithm.Maze." + refect_calss));
